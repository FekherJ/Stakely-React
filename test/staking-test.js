...
describe("Staking Contract", function () {
    ...
    beforeEach(async function () {
        ...
        stakingContract = await Staking.deploy(stakingToken.address, rewardToken.address);
    });

    it("Should allow user to stake tokens", async function () {
        // Approve and stake tokens for user1
        await stakingToken.connect(user1).approve(stakingContract.address, ethers.parseEther("100"));
    ...
    it("Should calculate and distribute rewards", async function () {
        ...
        await rewardToken.transfer(stakingContract.address, ethers.parseEther("100"));
    ...
    it("Should allow users to compound rewards", async function () {
        ...
        expect(updatedBalance).to.be.above(ethers.utils.parseEther("100")); // Should be greater than initial staking amount
    });
